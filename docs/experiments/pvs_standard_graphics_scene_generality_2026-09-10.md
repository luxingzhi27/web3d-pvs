...
### 18.5 2026-09-13 执行结果

九个 pilot 均完整执行 `8 x 450`，且各 checkpoint 的 calibration 冻结工作点都通过
validation WR/LCB 安全门。结果如下；Occlusion Recall 即 specificity，Useful Cull 为
`TN / candidate`：

| 场景 | K | WR | WR 95% LCB | Occlusion Recall | Useful Cull | Precision | Balanced Accuracy | Avg Pred |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| Sponza | 8 | 0.995372 | 0.992066 | 0.827069 | 0.673820 | 0.558915 | 0.895272 | 16.13 |
| Sponza | 16 | 0.995482 | 0.992176 | 0.821396 | 0.669198 | 0.552311 | 0.895108 | 16.41 |
| Sponza | 32 | 0.995358 | 0.992053 | 0.824537 | 0.671756 | 0.555213 | 0.893783 | 16.23 |
| Viking Village | 8 | 0.997180 | 0.993974 | 0.591707 | 0.443147 | 0.442381 | 0.778967 | 317.96 |
| Viking Village | 16 | 0.995503 | 0.990934 | 0.555201 | 0.415807 | 0.423488 | 0.764919 | 335.04 |
| Viking Village | 32 | 0.995506 | 0.990920 | 0.569446 | 0.426476 | 0.429953 | 0.769069 | 327.99 |
| Big City | 8 | 0.999826 | 0.999798 | 0.519181 | 0.407269 | 0.359771 | 0.751229 | 474.65 |
| Big City | 16 | 0.999834 | 0.999805 | 0.515019 | 0.404004 | 0.358001 | 0.749603 | 477.43 |
| Big City | 32 | 0.999843 | 0.999814 | 0.505159 | 0.396269 | 0.353754 | 0.745461 | 483.94 |

三场景均选择 K=8。增加关系容量提高了关系覆盖率，但没有提高安全门下的最终剔除效果；
因此不把 K=16/32 带入正式长训。Sponza、Viking Village 和 Big City 的 K=8 困难 pose
均衡采样三种子 `40 x 900` 已启动，旧 test 继续关闭。

V2 的 train-only 分布审计表明，Sponza、Viking Village、Big City 的平均候选数为
`49.24/583.13/786.54`，GT/candidate 比例为 `17.99%/22.82%/26.27%`；所有
