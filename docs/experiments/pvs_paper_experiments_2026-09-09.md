...
| AABB + Ray MLP | 部分完成 | HKUST、IFCBench 和标准场景 V1 三种子结果已完成。标准场景 V2 的学习率扫描及 Big City 三种子 validation 已完成；Big City 最佳安全 Useful Cull 仅 `0.000090`。Viking 正在 GPU0 长训，Sponza 已排队；全部不复用 V1 checkpoint、不读取 test |
