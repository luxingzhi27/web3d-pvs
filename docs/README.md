...
| 文档 | 内容 |
|---|---|
| [`experiments/pvs_train_owned_nonlinear_tail_posterior_longtrain_ablation_2026-08-19.md`](experiments/pvs_train_owned_nonlinear_tail_posterior_longtrain_ablation_2026-08-19.md) | 当前执行计划：基于现有 108 维视点区域特征比较固定线性、分段线性和小型 MLP 尾部分离能力，并对最优非线性组合执行三种子 80 epoch 同 checkpoint 后验消融 |
