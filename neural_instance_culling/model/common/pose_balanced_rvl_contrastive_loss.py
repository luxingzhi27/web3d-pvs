...
try:
    from common.pose_balanced_frontier_loss import pose_balanced_binary_cross_entropy
except ModuleNotFoundError:  # Package-style unittest import.
    from .pose_balanced_frontier_loss import pose_balanced_binary_cross_entropy
