...
from neural_instance_culling.model.train_pvs import (
    CALIBRATION_FLOOR,
...
from neural_instance_culling.model.pvs_model import (
...
class BoundedRelationSurvivalMomentSafetyTrainingTest(unittest.TestCase):
    def test_cli_defaults_to_current_visibility_objective(self) -> None:
        argv = [
            "train",
            "--dataset-dir", "dataset",
        ...
        self.assertEqual(args.utility_loss_weight, 0.0)
        self.assertEqual(args.download_loss_weight, 0.0)
        self.assertEqual(args.glb_resource_weight, 0.0)
        self.assertEqual(args.rvl_count_weight, 0.0)
        self.assertEqual(args.rvl_rank_weight, 0.0)
