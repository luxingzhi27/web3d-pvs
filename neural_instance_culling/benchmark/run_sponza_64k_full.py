#!/usr/bin/env python3
"""Train the three Full V4 seeds on the finalized Sponza 64 KiB dataset."""
...
EXPERIMENT = "pvs_v4_sponza_connected_sah_64k_full_v1"
SCENE = "sponza_64k"
...
def run_one(seed: int, gpu: int, *, smoke: bool = False) -> None:
    ...
    write_json(LOG_ROOT / f"{name}.command.json", {
        "schema": "pvs-sponza-64k-full-command-v1",
...
def main() -> None:
    ...
    if len(args.gpu_slots) < len(selected_seeds):
