...
SCENES = (
    {
        ...
        "experiment": "pvs_paper_runtime_hkust_v1",
        "expected": 684,
        "instances": 18831,
    ...
    },
    {
        ...
        "experiment": "pvs_paper_runtime_ifcbench_v1",
        "expected": 2710,
        "instances": 41298,
    ...
    {
        "id": "sponza",
        "label": "Sponza (672 test view-cells)",
        "dataset": "pose_csr_sponza_standard_graphics_128k_fov66_sampling_v2",
        "source": "neural_instance_culling/benchmark/out/paper_results/standard_graphics/"
        "optimization_v1/sampling_v2/sponza_128k/runtime_selected",
        "asset": "pvs_sponza_128k_v4_sampling_v2",
        "experiment": "pvs_paper_runtime_sponza_sampling_v2",
        "expected": 672,
        "instances": 132,
        "threshold": None,
        "radius": 0.75,
    ...
    {
        "id": "viking_village",
        "label": "Viking Village (276 test view-cells)",
        "dataset": "pose_csr_viking_village_standard_graphics_128k_fov66_sampling_v2",
        "source": "neural_instance_culling/benchmark/out/paper_results/standard_graphics/"
        "optimization_v1/sampling_v2/viking_village_128k/runtime_selected",
        "asset": "pvs_viking_village_128k_v4_sampling_v2",
        "experiment": "pvs_paper_runtime_viking_village_sampling_v2",
        "expected": 276,
        "instances": 1890,
        "threshold": None,
        "radius": 0.75,
    ...
    {
        "id": "bigcity",
        "label": "Big City (1608 test view-cells)",
        "dataset": "pose_csr_bigcity_standard_graphics_128k_fov66_sampling_v2",
        "source": "neural_instance_culling/benchmark/out/paper_results/standard_graphics/"
        "optimization_v1/sampling_v2/bigcity_128k/runtime_selected",
        "asset": "pvs_bigcity_128k_v4_sampling_v2",
        "experiment": "pvs_paper_runtime_bigcity_sampling_v2",
        "expected": 1608,
        "instances": 2734,
        "threshold": None,
        "radius": 0.75,
