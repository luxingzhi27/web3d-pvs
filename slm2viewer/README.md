...
实例化 v2 场景，并通过 WebGPU Worker 执行实例级可见性推理、真实视锥二次过滤和 GLB
下载调度。
...
详细运行时说明见 [`../docs/frontend/neuralstreamweb3d_runtime_implementation.md`](../docs/frontend/neuralstreamweb3d_runtime_implementation.md)，导出和部署资产说明见 [`../docs/frontend/neuralstreamweb3d_deployment_assets.md`](../docs/frontend/neuralstreamweb3d_deployment_assets.md)。
